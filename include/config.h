...
inline constexpr unsigned short CONFIG_CAM_SATURATION		 = 56;
inline constexpr short			CONFIG_CAM_HUE				 = 0;
inline constexpr bool			CONFIG_CAM_AUTO_WHITEBALANCE = false;
inline constexpr unsigned short CONFIG_CAM_GAMMA			 = 110;
inline constexpr unsigned short CONFIG_CAM_GAIN				 = 10;
...
inline constexpr unsigned short CONFIG_CAM_BACKLIGHT		 = 54;
inline constexpr unsigned short CONFIG_CAM_AUTO_EXPOSURE	 = 1;
inline constexpr unsigned short CONFIG_CAM_EXPOSURE_LEVEL	 = 156;
