...
% Create videowriter
if ANIMATE 
    video = VideoWriter ( [filename '.avi'] , 'Motion JPEG AVI' ) ; 
...
% Labels
timeLabelL = annotation('textbox', [0.001, 0.95, 0.2, 0.05], 'String', '', 'EdgeColor', 'none', 'FontSize', 12, 'Color', 'k', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top');
timeLabelR= annotation('textbox', [0.015, 0.95, 0.075, 0.05], 'String', '', 'EdgeColor', 'none', 'FontSize', 12, 'Color', 'k', 'HorizontalAlignment', 'right', 'VerticalAlignment', 'top');
errorLabelXL = annotation('textbox', [0.001, 0.92, 0.2, 0.05], 'String', '', 'EdgeColor', 'none', 'FontSize', 12, 'Color', colRedDk, 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top');
errorLabelXR = annotation('textbox', [0.015, 0.92, 0.075, 0.05], 'String', '', 'EdgeColor', 'none', 'FontSize', 12, 'Color', colRedDk, 'HorizontalAlignment', 'right', 'VerticalAlignment', 'top');
errorLabelYL = annotation('textbox', [0.001, 0.89, 0.2, 0.05], 'String', '', 'EdgeColor', 'none', 'FontSize', 12, 'Color', colGreDk, 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top');
errorLabelYR = annotation('textbox', [0.015, 0.89, 0.075, 0.05], 'String', '', 'EdgeColor', 'none', 'FontSize', 12, 'Color', colGreDk, 'HorizontalAlignment', 'right', 'VerticalAlignment', 'top');
errorLabelZL = annotation('textbox', [0.001, 0.86, 0.2, 0.05], 'String', '', 'EdgeColor', 'none', 'FontSize', 12, 'Color', colBlu, 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top');
errorLabelZR = annotation('textbox', [0.015, 0.86, 0.075, 0.05], 'String', '', 'EdgeColor', 'none', 'FontSize', 12, 'Color', colBlu, 'HorizontalAlignment', 'right', 'VerticalAlignment', 'top');
