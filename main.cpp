...
// // Testing libraries
// #include "include/FittsInterface.h"
...
// FittsInterface	 Fitts( Capture, OutputDisplay );
...
// 		if( !Fitts.testStarted ) {
// 			Fitts.StartTest( matBlank );
// 		} else {
// 			Fitts.CheckTest( cv::Point3i( x, y, int( clicked ) ), matBlank );
// 		}
